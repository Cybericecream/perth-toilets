...
import {LatestUserPassword, LoginPasswordResponse, User} from "../interfaces/auth-interfaces";
...
export const processLogin = async (command: LoginCommand, user: User, latestUserPassword: LatestUserPassword, hash: Hasher, jwt: JwtInterface): Promise<LoginPasswordResponse> => {
